...
export const PAISES = [
  ...
  // ── EL RESTO DE LATINOAMÉRICA (dueño, 6 sep 2026) ────────────────
  // «Agregá todos los países»: Bookea vende de México a Chile, y el
  // selector de país del alta de Lealtad mostraba ocho. Los trece de
  // abajo completan el mapa. Las regiones son las divisiones de primer
  ...
  // que es el catálogo que usa Solutions — hay un test que lo exige.
  {
    ...
    gentilicio: "beliceño",
    bandera: "🇧🇿",
    moneda: { codigo: "BZD", simbolo: "BZ$" },
    locale: "en-BZ",
    prefijoTelefono: "+501",
    zonas: ["America/Belize"] as const,
    region: { singular: "Distrito", plural: "Distritos" },
    regiones: ["Belize", "Cayo", "Corozal", "Orange Walk", "Stann Creek", "Toledo"],
  },
  {
    codigo: "ve",
    nombre: "Venezuela",
    ...
    bandera: "🇻🇪",
    moneda: { codigo: "VES", simbolo: "Bs." },
    locale: "es-VE",
    prefijoTelefono: "+58",
    zonas: ["America/Caracas"] as const,
    region: { singular: "Estado", plural: "Estados" },
    // Los 23 estados y el Distrito Capital.
    regiones: [
      "Amazonas",
      "Anzoátegui",
      "Apure",
  ...
  },
  {
    ...
    bandera: "🇪🇨",
    // Dolarizado desde 2000.
    moneda: { codigo: "USD", simbolo: "$" },
    locale: "es-EC",
    prefijoTelefono: "+593",
    zonas: ["America/Guayaquil", "Pacific/Galapagos"] as const,
    region: { singular: "Provincia", plural: "Provincias" },
    // Las 24 provincias.
    regiones: [
      "Azuay",
  ...
  },
  {
    ...
    bandera: "🇧🇴",
    moneda: { codigo: "BOB", simbolo: "Bs" },
    locale: "es-BO",
    prefijoTelefono: "+591",
    zonas: ["America/La_Paz"] as const,
    region: { singular: "Departamento", plural: "Departamentos" },
    regiones: ["Beni", "Chuquisaca", "Cochabamba", "La Paz", "Oruro", "Pando", "Potosí", "Santa Cruz", "Tarija"],
  },
  {
    codigo: "py",
    nombre: "Paraguay",
    ...
    bandera: "🇵🇾",
    moneda: { codigo: "PYG", simbolo: "₲" },
    locale: "es-PY",
    prefijoTelefono: "+595",
    zonas: ["America/Asuncion"] as const,
    region: { singular: "Departamento", plural: "Departamentos" },
    // Los 17 departamentos y Asunción (distrito capital).
    regiones: [
      "Alto Paraguay",
      "Alto Paraná",
      "Amambay",
  ...
  },
  {
    ...
    gentilicio: "uruguayo",
    bandera: "🇺🇾",
    moneda: { codigo: "UYU", simbolo: "$U" },
    locale: "es-UY",
    prefijoTelefono: "+598",
    zonas: ["America/Montevideo"] as const,
    region: { singular: "Departamento", plural: "Departamentos" },
  ...
  },
  {
    ...
    locale: "es-AR",
    prefijoTelefono: "+54",
    zonas: ["America/Argentina/Buenos_Aires"] as const,
    region: { singular: "Provincia", plural: "Provincias" },
  ...
  },
  {
    ...
    locale: "es-CL",
    prefijoTelefono: "+56",
    zonas: ["America/Santiago", "America/Punta_Arenas", "Pacific/Easter"] as const,
    region: { singular: "Región", plural: "Regiones" },
    // Las 16 regiones, de norte a sur, con el nombre corto de uso diario.
    regiones: [
      "Arica y Parinacota",
      "Tarapacá",
      "Antofagasta",
  ...
  },
  {
    ...
    locale: "pt-BR",
    prefijoTelefono: "+55",
    zonas: ["America/Sao_Paulo", "America/Manaus", "America/Fortaleza", "America/Cuiaba", "America/Rio_Branco"] as const,
    region: { singular: "Estado", plural: "Estados" },
    // Los 26 estados y el Distrito Federal, con su grafía en portugués.
    regiones: [
      "Acre",
      "Alagoas",
      "Amapá",
  ...
  },
  {
    ...
    bandera: "🇩🇴",
    moneda: { codigo: "DOP", simbolo: "RD$" },
    locale: "es-DO",
    // Comparte el +1 con Puerto Rico: los distingue el código de área
    // (809, 829 y 849 acá; 787 y 939 allá). Ver `paisDePrefijoUno`.
    prefijoTelefono: "+1",
    zonas: ["America/Santo_Domingo"] as const,
    region: { singular: "Provincia", plural: "Provincias" },
    // Las 31 provincias y el Distrito Nacional.
    regiones: [
      "Azua",
      "Baoruco",
      "Barahona",
  ...
  },
  {
    ...
    gentilicio: "cubano",
    bandera: "🇨🇺",
    moneda: { codigo: "CUP", simbolo: "$" },
    locale: "es-CU",
    prefijoTelefono: "+53",
    zonas: ["America/Havana"] as const,
    region: { singular: "Provincia", plural: "Provincias" },
  ...
  },
  {
    ...
    locale: "es-PR",
    prefijoTelefono: "+1",
    zonas: ["America/Puerto_Rico"] as const,
    region: { singular: "Municipio", plural: "Municipios" },
    // Sin división de primer nivel: los 78 municipios, que es como la
    // gente dice dónde queda un negocio.
    regiones: [
      "Adjuntas",
      "Aguada",
      "Aguadilla",
...
/**
 * República Dominicana y Puerto Rico comparten el +1 (el plan de
 * numeración norteamericano): el país lo dice el código de área que
 * sigue. 787 y 939 son de Puerto Rico; 809, 829 y 849, dominicanos.
 * Sin distinguir, un número boricua guardado como «+1 787…» se pintaría
 * como dominicano en el selector.
 */
export function paisDePrefijoUno(numeroLocal: string): CodigoPais {
  const digitos = (numeroLocal ?? "").replace(/\D/g, "");
  return digitos.startsWith("787") || digitos.startsWith("939") ? "pr" : "do";
}
