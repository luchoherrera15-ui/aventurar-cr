...
/**
 * La lupa única del directorio entiende fechas en español: si en el
 * texto viene "3 de agosto", "03/08", "mañana" o "este viernes", esa
 * parte se convierte en el filtro de disponibilidad y el resto queda
 * como búsqueda de texto normal.
 *
 * `interpretarBusqueda("dj 3 de agosto")` →
 *   `{ texto: "dj", fecha: "2026-08-03" }`.
 */
...
// cuando SÍ se detectó una fecha — en una búsqueda normal, "libre" o
// "día" podrían ser parte del nombre de un negocio.
