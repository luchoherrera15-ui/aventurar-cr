    ...
    <section id="reservar" className="py-9 pb-16">
      <div className="mx-auto max-w-[1080px] px-7">
        <div className="mb-6.5 max-w-[640px]">
          ...
          <h1 className="mt-2.5 text-[28px] font-bold text-aventurea-navy sm:text-[32px]">
            Reserva tu fecha
          </h1>
        ...
        <div className="grid gap-6 md:grid-cols-[1.2fr_1fr]">
          ...
          <div className="rounded-[18px] border border-aventurea-line bg-white p-5.5 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-[17px] font-bold capitalize text-aventurea-navy">
                {MESES[viewMonth]} {viewYear}
              </span>
              <div className="flex gap-2">
                <button
                  onClick={() => cambiarMes(-1)}
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-aventurea-line text-aventurea-navy hover:border-aventurea-orange hover:text-aventurea-orange-dark"
                >
                  ‹
                </button>
                <button
            ...
            <div className="mt-4.5 grid grid-cols-7 gap-1.5">
              {DOW.map((d, i) => (
                <div
                  key={i}
                  className="pb-1 text-center text-[10.5px] font-bold uppercase tracking-wide text-aventurea-ink-soft"
                >
                  {d}
                </div>
              ))}
              {celdas.map((d, i) => {
                ...
                if (isPast) {
                  cls += " text-[#C9C2AE] cursor-default";
                } else if (info?.confirmada) {
                  cls += " bg-aventurea-navy text-white font-bold";
                } else {
                  cls += " bg-aventurea-cream border border-aventurea-line cursor-pointer hover:border-aventurea-orange hover:text-aventurea-orange-dark";
                  if (info && info.pendientes > 0) {
                    cls += " bg-aventurea-orange-light border-aventurea-orange-light text-aventurea-orange-dark font-bold";
                  }
                }
                ...
                return (
                  ...
                  >
                    ...
                    {!isPast && info && info.pendientes > 0 && (
                      <span className="absolute -right-1 -top-1 flex h-[15px] w-[15px] items-center justify-center rounded-full bg-aventurea-navy text-[8.5px] font-bold text-white">
                        {info.pendientes}
                      </span>
                    )}
                  </div>
            ...
            <div className="mt-4.5 flex flex-wrap gap-4">
              <span className="flex items-center gap-1.5 text-[11.5px] text-aventurea-ink-soft">
                <span className="h-2.5 w-2.5 rounded-[3px] border border-aventurea-line bg-aventurea-cream" />
                Disponible
              </span>
              <span className="flex items-center gap-1.5 text-[11.5px] text-aventurea-ink-soft">
                <span className="h-2.5 w-2.5 rounded-[3px] border border-aventurea-orange bg-aventurea-orange-light" />
                Con solicitudes
              </span>
              <span className="flex items-center gap-1.5 text-[11.5px] text-aventurea-ink-soft">
                <span className="h-2.5 w-2.5 rounded-[3px] bg-aventurea-navy" />
                Confirmada
              </span>
            </div>

            <div className="mt-4 rounded-[10px] bg-aventurea-orange-light p-3 text-xs text-aventurea-orange-dark">
          ...
          <div className="rounded-[18px] border border-aventurea-line bg-white p-6 shadow-sm">
            {!selectedDate && (
              <div className="py-7 text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-aventurea-orange-light text-2xl">
                  📅
                </div>
                <h3 className="mt-4 text-[17px] font-bold text-aventurea-navy">
            ...
            {selectedDate && confirmado && (
              <div className="py-3.5 text-center">
                <div className="mx-auto flex h-13 w-13 items-center justify-center rounded-full bg-aventurea-orange-light text-2xl">
                  ✓
                </div>
                <h3 className="mt-3.5 text-lg font-bold text-aventurea-navy">
            ...
            {selectedDate && !confirmado && (
              <form onSubmit={enviarSolicitud} className="flex flex-col gap-3.5">
                ...
                <div className="text-base font-bold text-aventurea-navy">
                ...
                {dias[selectedDate] && dias[selectedDate].pendientes > 0 && (
                  <div className="rounded-[10px] bg-aventurea-orange-light p-3 text-xs leading-relaxed text-aventurea-orange-dark">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej. 40"
                    className="w-full rounded-[10px] border-[1.5px] border-aventurea-line px-3 py-2.5 text-[13.5px]"
                  />
                </div>

                <div className="flex items-center justify-between rounded-xl border-[1.5px] border-aventurea-line px-3.5 py-3">
                  <span className="text-[10.5px] font-bold uppercase tracking-wide text-aventurea-ink-soft">
                    Precio estimado
                  </span>
                  <span className="text-[15px] font-bold text-aventurea-navy">
                    {tierBase === null
                      ? invitadosNum
                        ...
                        return (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <span className="ml-1.5 text-xs font-bold text-aventurea-orange-dark">
                                {fmtColones(s.precio)}
                              </span>
                              {s.requisito_max_invitados && (
                                <div className="mt-0.5 text-[11px] text-aventurea-ink-soft">
                                  {eligible
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="min-h-[56px] w-full rounded-[10px] border-[1.5px] border-aventurea-line px-3 py-2.5 text-[13.5px]"
                  />
                </div>

                {total !== null && (
                  <div className="flex items-center justify-between rounded-xl bg-aventurea-navy px-3.5 py-3">
                    <span className="text-[10.5px] font-bold uppercase tracking-wide text-[#AFC6E0]">
                      Total estimado
                    </span>
                ...
                <div>
                  ...
                  <label className="flex cursor-pointer flex-col items-center gap-2 rounded-xl border-[1.5px] border-dashed border-aventurea-line p-4 text-center hover:border-aventurea-orange">
                    <input
                      type="file"
                      accept="image/*"
                      required
                ...
                <button
                  type="button"
                  onClick={limpiarSeleccion}
                  className="text-center text-xs text-aventurea-ink-soft underline hover:text-aventurea-navy"
                >
                  ← Elegir otra fecha
                </button>
              </form>
