...
export const metadata: Metadata = {
  title: { absolute: "Ingresá · Bookea" },
  description: "Entrá a tu cuenta para editar tu página de Bookea.",
  alternates: { canonical: "/solutions/login" },
};
...
export default async function LoginLinksyPage() {
  ...
  return (
    <main className="grid min-h-svh lg:grid-cols-2">
      ...
      >
        <Link href="/solutions" className="titulo text-[28px] font-extrabold tracking-tight" style={{ color: "var(--linksy-lima-tinta)" }}>
          Bookea
        </Link>
