  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="rounded-2xl border border-aventurea-line bg-white p-5.5 shadow-sm">
        ...
        <h3 className="mt-1 text-[15.5px] font-bold text-aventurea-navy">
              ...
              <tr key={t.key}>
                <td className="py-1.5 pr-2">
                  <input
                    ...
                    className="w-full rounded-lg border-[1.5px] border-aventurea-line bg-aventurea-cream px-2.5 py-2 text-[13px]"
                  />
                </td>
                <td className="py-1.5 pr-2">
                  <input
                ...
                <td className="py-1.5">
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-lg border border-aventurea-line text-aventurea-ink-soft hover:border-red-400 hover:text-red-600"
                    title="Eliminar"
                  >
                    🗑
                  </button>
        ...
        <button
          ...
          className="mt-3.5 rounded-lg border-[1.5px] border-aventurea-line bg-white px-3.5 py-2 text-[11.5px] font-bold text-aventurea-navy hover:border-aventurea-orange hover:text-aventurea-orange-dark"
        >
          ＋ Agregar rango
        </button>

        <div className="mt-4.5 border-t border-dashed border-aventurea-line pt-4">
          <label className="mb-1.5 block text-[11px] font-bold uppercase tracking-wide text-aventurea-orange-dark">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-32 rounded-lg border-[1.5px] border-aventurea-line bg-aventurea-cream px-2.5 py-2 text-[13px]"
            />
        ...
        {message && (
          <span
            className={`text-[12.5px] font-bold ${
              message.type === "ok" ? "text-aventurea-green" : "text-red-600"
            }`}
          >
            {message.type === "ok" ? "✓ " : ""}
            {message.text}
