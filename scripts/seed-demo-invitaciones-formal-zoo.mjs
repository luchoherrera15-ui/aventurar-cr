// Siembra las demos de invitación "formal" (gala) y "zoológico"
// (infantil) desde sus plantillas de docs/plantillas-invitaciones,
// sustituyendo los placeholders. Idempotente: upsert por slug.
...
const { data } = await db
  .from("invitaciones")
  .select("slug, estado")
  .in("slug", ["demo-formal", "demo-zoologico"]);
